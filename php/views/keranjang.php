                        ...
                        <table width="80%" border="1" style="margin:5% 10% 5% 10%;">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "select * from order_temp join produk using(id_produk) join pelanggan using(id_pelanggan) where id_pelanggan='$id_pelanggan'";
                                    ...
                                    foreach($keranjang as $row){?>
                                        <tr>
                                            ...
                                            <td style="padding: .5%;">
                                                <a href=""><i class="fa fa-trash" style="color:pink;"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                ...
                                <tr>
                                    <td colspan="3" style="padding: .5%;" align="right">Sub Total</td>
                                    <td colspan="2" style="padding: .5%;">Rp <?=$subtot?></td>
                                </tr>
                            </tbody>
                        </table>
                        <div>
                            <a href="detail-order.php"><input type="button" value="CHECKOUT" class="btn-cekout"></a>
                        </div>
                </div>
            </main>
            <footer>
